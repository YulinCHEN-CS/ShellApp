[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-7f7980b617ed060a017424585567c406b6ee15c891e84e1186181d67ecf80aa0.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=12423736)
# COMP0010 Shell
...
<u>Result</u> (NOTE: The weird output is one of the test for input with invalid grammar):

<img src="images/unit_test.jpg" alt="image-20231211230552877" style="zoom:25%;" />
...
<img src="images/analysis_result.jpg" alt="image-20231211230552877" style="zoom:25%;" />
...
<img src="images/coverage.jpg" alt="image-20231211230552877" style="zoom:45%;" />
...
<img src="images/system_test.jpg" alt="image-20231211230552877" style="zoom:%;" />

Individual system tests (e.g. `test_cat`) can be executed as

    python system_test/tests.py -v TestShell.test_cat

To re-generate antlr files, run (Sample inside src/antlr/generated with specific optimisation, re-generated may affect the efficiency)

```shell
antlr4 -Dlanguage=Python3 -no-listener -o src/antlr/generated src/antlr/ShellGrammar.g4
```
...
In COMP0010 Shell, each Call command has an unsafe variant. An unsafe version of a call that call an application that has the same semantics as the original application, but instead of raising exceptions, it prints the error message to its stdout. This feature can be used to prevent long sequences from terminating early when some intermediate commands fail. This feature implemented inside Call.py which enables exception-print if unsafe flag  ```_``` recognised at the front.
